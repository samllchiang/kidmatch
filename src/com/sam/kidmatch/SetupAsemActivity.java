...
public class SetupAsemActivity extends ListActivity {
	
	static KidMatchApp appState;
	private Elem elem;
	Context context;
	private ParseQueryAdapter<Elem> mainAdapter;
	private AsemListAdapter asemListAdapter;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		super.onCreate(savedInstanceState);
			...
			asemListAdapter = new AsemListAdapter(this);

			// Default view is all elems
			asemListAdapter.loadObjects();
			setListAdapter(asemListAdapter);				
	}//end of onCreate
