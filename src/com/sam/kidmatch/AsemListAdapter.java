...
public class AsemListAdapter extends ParseQueryAdapter<Elem> {
	...
	public AsemListAdapter(final Context context) {
...
//					 
//					Log.e("-----listQueryElem.size()-----",+sizelistQueryElem+						      
...
//				            Log.e("--***---isChecked0--***---", "---ansPhotoChecked-------- "+ansPhotoChecked.size()+
//				                    "--sizelistQueryElem--"+sizelistQueryElem);
				        }// for(int i=0;i<sizelistQueryElem;i++) 
